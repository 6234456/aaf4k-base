...
class ReportingPackage0(
    targetReportingTmpl: Reporting,
    ...
    val targetReporting =
        (targetReportingTmpl.deepCopy() as Reporting).apply { clearCategories(); prepareConsolidation() }
    ...
    fun localReportingOf(
        localReporting: Reporting,
        translator: ReportingTranslator? = null,
    ...
    fun carryForward(targetReportingPackage: ReportingPackage0): ReportingPackage0 {
